...
def main(stdscr):
    ...
    output_window_border = curses.newwin(output_window_height, output_window_width, height + 2, slot_window_width+3)
    display_box(output_window_border, height + 2, slot_window_width+3, output_window_height, output_window_width, "Output")
    pad_pos = 0
    ...
    if operation in ['s', 'b']:
        ...
        pad_pos = sbr.run_test(output_window, user_password, inputnum_loops, kill, slotlist, pad_pos)
